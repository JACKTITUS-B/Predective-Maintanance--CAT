      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md border border-stone-200 dark:border-stone-800 shadow-xl overflow-hidden relative">
          ...
          <CardHeader className="text-center pt-8">
            ...
            <CardTitle className="text-xl font-extrabold tracking-tight">RECOVER PASSWORD</CardTitle>
            <CardDescription>Enter your email to receive a password reset validation link</CardDescription>
          </CardHeader>
            ...
            {success ? (
              <div className="space-y-4">
                <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-xs font-bold rounded text-center">
                  Password reset link has been dispatched to {email} if an account exists.
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-center mt-4">
                  <Link
                    href="/login"
                    className="text-xs font-bold text-stone-500 hover:text-[#FFCD00] transition-colors"
                  >
                    Return to Login
                  </Link>
                </div>
